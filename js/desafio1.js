...
function extraiId(listadeprod) {
  var listadeid = [];

  for (let produto of listadeprod) {
    listadeid.push(produto.id);
  }
  return listadeid;
}
function chamaextraiId(){
  let resultado = extraiId(listadeprod)
  console.log(resultado)
 }
//      Desafio 2

//FUNÇÃO QUE BUSCA TODAS AS INFORMAÇÕES DO ITEM BUSCANDO PELO NOME//
function pegaprodutopelonome(listadeprod, nomedoproduto) {
  for (let produto of listadeprod) {
...
function extraicategoria(listadeprod) {
...
function filtrarprodutospelorate(listadeprod, rate) {
  for (let produto of listadeprod) {
...
function filtrarprodutospeloprecomaior(listadeprod, preco) {
  for (let produto of listadeprod) {
...
function filtrarprodutospeloprecomenor(listadeprod, preco) {
  for (let produto of listadeprod) {
    let price = produto.price;
    if (preco >= produto.price) {
      return produto;
...
function filtrarporpalavra(listadeprod, palavra) {
  for (let produto of listadeprod) {
